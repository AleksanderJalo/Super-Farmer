...
const OptionsButton = () => {
  return (
    <div className="font-plaguard cursor-pointer flex shadow-2xl border-4 transition ease-in-out hover:-translate-y-1 duration-300  border-black text-white group z-20">
